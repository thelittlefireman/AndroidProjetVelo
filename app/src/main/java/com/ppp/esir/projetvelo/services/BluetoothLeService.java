package com.ppp.esir.projetvelo.services;/*
...
public class BluetoothLeService extends Service {
    ...
    public final UUID UUID_BLE_SERVICE = java.util.UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");
    public final UUID UUID_SEND_READ = java.util.UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(final BluetoothGatt gatt, final int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattService mBluetoothGattService = mBluetoothGatt.getService(UUID_BLE_SERVICE);
                BluetoothGattCharacteristic characteristicRead =
                        mBluetoothGattService.getCharacteristic(UUID_SEND_READ);
    ...
    private void read_Characteristic() {
        readCharacteristic(mWriteCharacteristic.element());
        setCharacteristicNotification(mWriteCharacteristic.element(), true);
